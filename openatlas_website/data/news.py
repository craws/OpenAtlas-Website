...
news_ = {
    'News': {
        '2026-04-15': {
            ...
            'text': release_text(53) +
                    '<br>Also, we are happy to announce a new cooperation '
                    'with WHEIM.<br>'
                    'You can find more details at the '
                    '<a href="/projects">projects</a> page.'},
        '2026-02-06': {
            'title':
                'OpenAtlas version 9.1.0, OpenAtlas Discovery 1.0.0',
    ...
    '2025': {
        '2025-11-15': {
            'title':
                'OpenAtlas version 8.15.0 and a new cooperation with '
                'Epigraphies of Pious Travel',
            'text': release_text(50) +
    ...
    '2021': {
        ...
        '2021-06-18': {
            ...
            'text':
                ...
                'between-wealth-and-poverty/">MAMEMS homepage</a>'},
        '2021-06-13': {
