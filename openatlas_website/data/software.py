stack = {
    'Python': {
        ...
        'text': 'is an interpreted, high-level, general-purpose programming language.',
        'img': 'python.png',
        'license': 'Python Software Foundation License'},
    'Flask': {
        'url': 'https://palletsprojects.com/p/flask/',
        'text': '''is a micro web framework, written in Python, with the ability to scale up to 
    ...
    'PostGIS': {
        ...
        'text': '''is a spatial database extender for PostgreSQL and
